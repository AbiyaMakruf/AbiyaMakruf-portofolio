<x-layouts.app title="Manage Achievements">
    <div class="p-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            <a href="{{ route('admin.achievements.create') }}" class="w-full sm:w-auto text-center rounded-lg bg-[#00B3DB] px-4 py-2 text-sm font-semibold text-white hover:bg-[#0A7396]">
                + Add Achievement
            </a>
        </div>
        ...
        <div class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
            <div class="overflow-x-auto">
                <table class="w-full min-w-[680px] text-left text-sm text-slate-600 dark:text-slate-400">
