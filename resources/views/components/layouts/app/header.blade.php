...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-gradient-to-br from-[#F4FBFF] via-white to-[#E6FAF2] text-slate-800">
        <flux:header container class="border-b border-slate-100 bg-white/80 backdrop-blur-lg z-50">
            ...
            <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
                <flux:navbar.item class="!h-10 [&>div>svg]:size-5" icon="arrow-top-right-on-square" href="{{ route('home') }}" target="_blank" :label="__('View Site')" />
            </flux:navbar>
