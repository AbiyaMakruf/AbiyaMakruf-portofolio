            ...
            <div class="flex flex-col h-full p-6">
                ...
                <nav class="flex-1 space-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('admin.cv.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.cv.*') ? 'bg-gradient-to-r from-primary-500 to-accent-500 text-white shadow-lg' : 'text-zinc-700 dark:text-zinc-300 hover:bg-white/50 dark:hover:bg-white/10' }}">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
